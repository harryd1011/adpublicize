...
<body>
    ...
    <div class="row ">
        <section class="bg-dark col-md-2 col-5" style="height:100vh;">
            ...
            <div id="accordian">
                ...
                <div class="card bg-dark">
                    ...
                    <div id="collapseTwo" class="collapse text-white" data-bs-parent="#accordion">
                        <div class="container mt-3">
                            <ul class="nav flex-column">
                                <li class="nav-item ">
